...
var githubApiKey = exports.githubApiKey = 'd620e95d99b516f732720d4ccc26e1e70fc0a31d';
...
function controllerRouter() {
  ...
  if (currentRoute.length === 0) {
    currentRoute = 'home';
    var fetchProfilePromise = _jquery2.default.getJSON('https://api.github.com/users/ajmason20');
    var fetchRepoPromise = _jquery2.default.getJSON('https://api.github.com/users/ajmason20/repos');
  ...
  if (currentRoute !== 'home') {
    var fetchProfilePromise = _jquery2.default.getJSON('https://api.github.com/users/' + currentRoute);
    var fetchRepoPromise = _jquery2.default.getJSON('https://api.github.com/users/' + currentRoute + '/repos');
